          ...
          >
            {projects.map((project) => (
              <SwiperSlide key={project.id} className="rounded-md shadow p-6">
                <div className="borde rounded-md max-h-[260px] overflow-hidden" onClick={() => {
          ...
          <div className="detailbg relative rounded-lg z-10">
            ...
            <div className="p-8 md:p-12 ">
              ...
              <p className="mt-4 mb-2 text-xl font-bold text-gradient">
                ...
                {
                  selectedProject?.technologies?.map(t => <p key={t} className="px-3 py-1 rounded-lg shadow-md border bg-gray-200 ">{t}</p> )
                }
                </div>
              ...
              <div className="flex gap-4 mt-4 justify-end text-gray-300 border-t border-gray-600 pt-2">
                  <Link className="flex gap-1 items-center hover:underline hover:text-purple-500" href={selectedProject.client} target="blank"><span className="text-2xl "><FaGithub /></span> client</Link>
                  <Link className="flex gap-1 items-center  hover:underline hover:text-purple-500"  href={selectedProject.server} target="blank"><span className="text-2xl"><FaGithub /></span> Server</Link>
              </div>
            </div>
          </div>
        </div>
